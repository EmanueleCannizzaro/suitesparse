...
int main (int argc, char **argv)
{
    ...
    /* here is an example of how to use AMD_VERSION.  This code will work in any version of AMD. */
    ...
    printf ("\nreturn value from amd_order: " ID " (should be %d)\n",
            result, AMD_OK) ;
    ...
    printf ("Execution of AMD demo: OK\n");
    return (EXIT_SUCCESS);
}
