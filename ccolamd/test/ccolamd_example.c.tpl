...
/* COLAMD / SYMAMD example
    ...
    See the ccolamd.c for the routines this program calls, and for the License.
*/
...
int main (void)
{
    ...
    ok = CSYMAMD() (B_N, B, q, perm, (double *) NULL, stats, &calloc, &free, NULL, -1) ;
    CSYMAMD(report) (stats) ;
