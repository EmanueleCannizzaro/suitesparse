...
{ \
    ...
    if (Common->itype != CHOLMOD_LONG || Common->dtype != CHOLMOD_DOUBLE) \
    { \
 ...
 *	(2) most integers are int, some are Int
 *	(3) all integers are Int
 *
 ...
 *	DLONG	double, Int	prefix: cholmod_l_
 *	DMIX	double, mixed int/Int	prefix: cholmod_m_
 *	SINT	float, int			prefix: cholmod_si_
 *	SLONG	float, Int		prefix: cholmod_sl_
 ...
 *
 * Int is normally defined as long.  However, for WIN64 it is
...
/* -------------------------------------------------------------------------- */
/* double (also complex double), Int */
/* -------------------------------------------------------------------------- */

#ifdef DLONG
#define CHOLMOD(name) cholmod ## _l_ ## name
#else
#define CHOLMOD(name) cholmod ## _i_ ## name
#endif
...
/* double, int */
EXTERN int CHOLMOD(dump);
EXTERN int CHOLMOD(dump_malloc);

Int CHOLMOD(dump_sparse) (cholmod_sparse  *, const char *, cholmod_common *) ;
Int  CHOLMOD(dump_factor) (cholmod_factor  *, const char *, cholmod_common *) ;
Int  CHOLMOD(dump_triplet) (cholmod_triplet *, const char *, cholmod_common *) ;
Int  CHOLMOD(dump_dense) (cholmod_dense   *, const char *, cholmod_common *) ;
Int  CHOLMOD(dump_subset) (int *, size_t, size_t, const char *, cholmod_common *) ;
Int  CHOLMOD(dump_perm) (int *, size_t, size_t, const char *, cholmod_common *) ;
Int  CHOLMOD(dump_parent) (int *, size_t, const char *, cholmod_common *) ;
void CHOLMOD(dump_init) (const char *, cholmod_common *) ;
Int  CHOLMOD(dump_mem) (const char *, Int, cholmod_common *) ;
void CHOLMOD(dump_real) (const char *, Real *, Int, Int, int, int, cholmod_common *) ;
void CHOLMOD(dump_super)  (Int, int *, int *, int *, int *, double *, int, cholmod_common *) ;
Int  CHOLMOD(dump_partition) (Int, int *, int *, int *, int *, Int, cholmod_common *) ;
Int  CHOLMOD(dump_work) (int, int, Int, cholmod_common *) ;
